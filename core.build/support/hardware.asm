...
;
		...
		add 	a,__wc_colours & 255 				; add __wc_colours, put in DE
		ld 		e,a
		ld 		a,__wc_colours / 256
		adc 	a,0
		ld 		d,a
		ld 		a,(de)								; get colours.
		ld 		(hl),a
...
__dhl1:	push 	af 									; save byte
		rrca 										; get high nibble
		rrca
		rrca
		rrca
		call 	__dhl2 								; print it
		pop 	af									; get low nibble
__dhl2:	and 	$0F 								; mask low 4 bits
		cp 		10
		jr 		c,__dhl3
		add 	a,-48-9	
__dhl3:	add 	a,48
		call 	IOWriteCharacter					; display it
		inc 	hl 									; next character slot right
		ret
